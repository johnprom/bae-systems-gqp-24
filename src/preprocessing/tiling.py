...
# TODO: AMIT: Uncomment the next import, make sure you've pushed Tiling_images_to_yolo.py in the src/preprocessing directory
# Alternatively, you can place the code that you have in Tiling_images_to_yolo.py right into this file
...
def tiling(ctxt):
    ...
    # # TODO: AMIT: Uncomment the following code. Coordinate with GABE.
