...
def update_knee_results(ctxt, name, orig_image_size, degradation_factor, mAP):
    ...
    rcdf.loc[rcdf.shape[0]] = [name, orig_image_size[0], orig_image_size[1], degraded_width, 
                               degraded_height, mAP, degradation_factor, True]
...
# def run_eval_on_degrade(ctxt, degradation_factor, baseline_image_size, degraded_image_size, val_degraded_dir_path):
#     """
#     Run the model evaluation at a specific resolution and calculate mAP.
...
#     degraded_image_size = baseline_image_size 
